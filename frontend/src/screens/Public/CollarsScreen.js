  ...
  const products = [
    {
      ...
      price: 7.50,
      image: require('../../../assets/Collares/Necklaces.png'),
      rating: 5.0,
      reviews: 15,
      ...
      sizes: ['XS', 'S', 'M', 'L'],
      images: [
        require('../../../assets/Collares/Necklaces9.png'),
        require('../../../assets/Collares/Necklaces2.png'),
        require('../../../assets/Collares/Necklaces3.png'),
      ]
    },
    {
      id: 2,
      ...
      price: 8.00,
      image: require('../../../assets/Collares/Necklaces4.png'),
      rating: 4.5,
      reviews: 12,
      ...
      sizes: ['XS', 'S', 'M', 'L'],
      images: [
        require('../../../assets/Collares/Necklaces5.png'),
        require('../../../assets/Collares/Necklaces6.png'),
        require('../../../assets/Collares/Necklaces7.png'),
      ]
    }
  ];
